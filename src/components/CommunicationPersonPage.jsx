...
export default function CommunicationPersonPage({person,onSave,onBack}){
  ...
  function updateFlowNote(level,text){
    setLocal(previous=>{const profile=friendLogic.normalizeCommunication(previous);return {...previous,communication:{...profile,conversationFlowNotes:{...(profile.conversationFlowNotes||{}),[level]:text},updatedAt:new Date().toISOString()}}})
  }
